...
export default function Footer() {
  ...
  return (
    <div className="w-full flex flex-col items-center px-4 mt-0 md:mt-2">
      {/* 渐变星光横线 */}
      <div className="w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-white/30 to-transparent mb-6" />

      {/* Footer 内容 + 下边距 */}
      <footer className="text-center text-sm text-[#ddcbaa] leading-relaxed tracking-wide max-w-xl mb-3 md:mb-6">
        {text}
      </footer>
    </div>
  );
